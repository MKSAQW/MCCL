...
parser.add_argument('--config', type=str, default="/home/y212202015/Feature/Unimatch_noise/Unimatch/configs/pascal.yaml")
...
parser.add_argument('--save-path', type=str, default="/home/y212202015/UniMatch-main/out/best.pth")
parser.add_argument('--imagepath', type=str, default="/home/y212202015/UniMatch-main/supervised_image")
...
def main():
    ...
    for img,mask,id in valloader:
        ...
        cv2.imwrite(os.path.join(args.imagepath,str(id).split(" ")[0][2:].split("/")[1].split(".")[0]+".png"), image)
